...
import type {AnchoredOverlayEventMap, AnchoredOverlayOptions, StandardOverlayDefinition,} from "./types";
...
> {
  ...
  public setCoordinate(coordinate: LngLatLike): this {
    ...
    this.fire("coordinateChanged", { id: this.id, coordinate } as never);
    return this;
  }
